...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void _loadSettings() {
    setState(() {
      ...
      _confidenceThreshold = widget.settingsService.confidenceThreshold;
      _detectionInterval = widget.settingsService.detectionInterval;
                ...
                child: Column(
                  children: [
                      ...
                      child: Column(
                        children: [
                          Slider(
                            ...
                            onChangeEnd: (value) async {
                              await widget.settingsService.setConfidenceThreshold(value);
                            },
                          ),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    ...
                    _buildSettingCard(
                      ...
                      subtitle: '${_detectionInterval}s between scans',
                      icon: Icons.timer,
  ...
  Widget _buildIntervalChip(int seconds) {
    final isSelected = _detectionInterval == seconds;
    return GestureDetector(
      onTap: () async {
        setState(() {
          _detectionInterval = seconds;
        });
        await widget.settingsService.setDetectionInterval(seconds);
      },
      child: Container(
        padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 12),
        decoration: BoxDecoration(
          color: isSelected ? const Color(0xFF9ED8FF) : Colors.grey.withOpacity(0.2),
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
            color: isSelected ? const Color(0xFF9ED8FF) : Colors.transparent,
            width: 2,
          ),
        ),
        child: Text(
